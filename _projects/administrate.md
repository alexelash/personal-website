...
title: "Administrate Brand"
seo_description: "Creative direction, brand management, marketing, and web design for a corporate training SaaS company."

featured-image: "administrate/administrate_rebrand_hero.png"
featured-size: "cropped"
featured-alt: "Administrate logo."
featured-bg: "#3B1EA3"

excerpt: "Logo and visual identity"
...
hero:
  ...
  roles: "Creative Director (Solo)"
  timeline: "8 months"
  impact:
    - In-house execution
    - Successful repositioning for enterprise
    - Increased trade show foot traffic
  organization:
    name: Administrate
...
sections:
  ...
  - type: "grid"
    layout: "side-by-side"
    caption: Old logo and visual identity applied. The previous full logo next to the one I designed.
    visual:
      - image: "administrate/administrate_old_logo_01.jpg"
        image-alt: "Old Administrate logomark (an A set against a gradient backdrop) and full logo with tagline."
      - image: "administrate/administrate_old_logo_03.jpg"
        image-alt: "Previous logo applications on social media, badges, and more."
      - image: "administrate/administrate_old_logo_02.jpg"
        image-alt: "The old Administrate logo before and how it was adjusted for Administrate's next chapter."
  - type: "default"
    layout: "text-only"
    desc: |
      ## The problem
  ...
  - type: "grid"
    layout: "stacked"
    caption: Screenshot of the form that executive stakeholders filled and resulting data.
    visual:
      - image: "administrate/administrate_exec_exercise_02.jpg"
        image-alt: "Form on a mobile phone and an example of one of the slides demonstrating how it applies in real-life brands."
      - image: "administrate/administrate_exec_exercise_01.jpg"
        image-alt: "End results from the stakeholder exercise."
  - type: "default"
    layout: "text-only"
    desc: |
      ...
      **Why this direction won:**
      During concept development, I explored multiple directions—including more conservative evolutions of the existing mark. The asymmetrical beam concept stood out because it:
  ...
  - type: "default"
    ...
    desc: |
      ...
      ![Old purple color swatch with an arrow pointing to an updated purple color swatch.](/assets/images/projects/administrate/administrate_color_02.png)
      ...
      ![Screenshot of the full brand and grayscale palette as well as the UI palette semantic colors.](/assets/images/projects/administrate/administrate_color_01.png)

      ### Rollout and documentation
      ![Screenshot of the full brand and grayscale palette as well as the UI palette semantic colors.](/assets/images/projects/administrate/administrate_guidelines_01.png)
  ...
  - type: "default"
    ...
    visual:
      type: "slider"
      caption: "Digital applications of the new brand."
      slides:
        - image: "administrate/administrate_website_01.jpg"
          image-alt: "Mobile and desktop screenshots of revised Administrate homepage using the new brand identity."
        - image: "administrate/administrate_website_02.jpg"
          image-alt: "Screenshot of Administrate's pricing page."
        - image: "administrate/administrate_website_03.jpg"
          image-alt: "Screenshot of a lead capture form on the Administrate site."
        - image: "administrate/administrate_website_04.jpg"
          image-alt: "Screenshot of custom illustrations I designed on Administrate's website."
  - type: "default"
    layout: "text-only"
    desc: |
  ...
  - type: "default"
    ...
    visual:
      type: "slider"
      caption: "Digital and print applications of the new brand."
      slides:
        - image: "administrate/administrate_applied_brand_01.jpg"
          image-alt: "Waterbottles branded with Administrate's logo."
        - image: "administrate/administrate_applied_brand_02.jpg"
          image-alt: "New identity in a tradeshow design."
        - image: "administrate/administrate_applied_brand_03.jpg"
          image-alt: "Smaller tradeshow presence with the Administrate brand."
        - image: "administrate/administrate_applied_brand_04.jpg"
          image-alt: "Acrylic pins in various accent colors branded for an event."
        - image: "administrate/administrate_applied_brand_06.jpg"
          image-alt: "Photo of nametags with branded lanyards from a Customer Summit."
  - type: "default"
    layout: "text-only"
    desc: |
      ## Results
  ...
  - type: "default"
    ...
    visual:
      type: image
      image: "administrate/administrate_applied_brand_05.jpg"
      image-alt: "Photo of a box with an Administrate-branded cap, water bottle, and hoodie"
      caption: "Photo of swag box given out to all existing employees, some key customers and partners, and new hires."
  - type: "default"
    layout: "text-only"
    desc: |
